      ...
      <FormPageContainer>
        ...
        >            
          <h3 className='mr-11 flex items-center font-heading text-xl font-bold text-primary'>
            <SuccessIcon className='h-8 w-8 fill-success mr-3' /> Enrollment received
          </h3>
          <p className='font-body text-base text-primary'>We will be contacting you within 1 business day to confirm your registration details.</p>
          <Link href='/students'>
