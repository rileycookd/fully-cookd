    ...
    <FormPageContainer>
      ...
      >            
        <h3 className='mr-11 flex items-center font-heading text-xl font-bold text-primary'>
          <ErrorIcon className='h-8 w-8 fill-error mr-3' /> Registration error
        </h3>
        <p className='font-body text-base text-primary mb-6'>We're sorry, but we couldn't register you at this time. Please try contacting us directly.</p>
